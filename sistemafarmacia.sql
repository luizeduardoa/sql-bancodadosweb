...
--Selecionando os dados de uma coluna
SELECT nomefarmacia;
FROM farmacia;
...
--Selecionando com ordem ascedente/crescente

SELECT * FROM farmacia
ORDER BY nomefarmacia ASC;

--Selecionando com ordem descendente/descrecente
SELECT * FROM produto
ORDER BY codproduto = 4;
...
FROM farmacia
INNER JOIN produto
ON farmacia.cpnj = produto.cnpj_farmacia
...
--Producedure: listar produtos de uma farmácia
...
--Procedure: atualizar o calor do produto
DELIMITER $$
...
BEGIN
    ...
    SELECT qtd_produtos_farmacia('1234567800199') AS total_em_estoque;
